...
describe RSSParser do
  ...
  describe ".parse(heise-atom)" do
    ...
    it "should parse <updated> (atom)" do
      ...
      expect(item.summary).to eq "Nachdem vermutlich russische Hacker der IT des deutschen Parlaments schweren Schaden zugef\u251C\u255Dgt hatten, nehmen sie nun offenbar auch andere politische Player ins Fadenkreuz. "
